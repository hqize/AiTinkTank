...
if __name__ == "__main__":
    ...
    json_path = str( _backend_dir / "out" / "H3C LA2608室内无线网关 用户手册-6W100-整本手册" / "state_vector.json")
    ...
    node_import_milvus.logger.info(json.dumps(result, ensure_ascii=False, indent=4))
